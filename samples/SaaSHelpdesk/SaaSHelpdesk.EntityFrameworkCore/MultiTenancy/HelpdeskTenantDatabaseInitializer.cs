...
namespace SaaSHelpdesk.EntityFrameworkCore.MultiTenancy;

/// <summary>
/// PostgreSQL implementation of <see cref="ITenantDatabaseInitializer"/>.
/// Creates the tenant's database if it does not exist.
/// </summary>
public class HelpdeskTenantDatabaseInitializer : ITenantDatabaseInitializer
{
    private readonly ILogger<HelpdeskTenantDatabaseInitializer> _logger;

    public HelpdeskTenantDatabaseInitializer(ILogger<HelpdeskTenantDatabaseInitializer> logger)
    {
        _logger = logger;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            // Connect to the 'postgres' maintenance database to check/create the target database
            ...
            if (!exists)
            {
                // PostgreSQL uses double-quote quoting for identifiers
