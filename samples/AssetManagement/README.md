...
| Workarounds | Explicit NativeAOT consumer factory; the canonical Workflow abort authority atomically compensates suspended Runtime records after a business-store failure and replays commit-unknown outcomes by stable operation receipt; E2E uses a CI PostgreSQL service | AOT / cross-authority boundary |
