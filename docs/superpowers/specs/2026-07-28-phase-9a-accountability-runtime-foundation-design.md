...
HttpTerminalOutcomeCompositionTests
  BusinessExceptionIsConvertedBeforeHttpFact
  ...
  TenantResolverExceptionUsesGlobalErrorContract
  AuthenticationHandlerExceptionUsesGlobalErrorContract
  PreScopeFailureProducesUnknownActorHttpFact
  AuthenticatedBusinessRequestPushesChildScope
  TerminalObserverUsesSameAuditAndOperationIdsAsChildScope
  AuditFailureDoesNotReplacePreScopeErrorResponse
