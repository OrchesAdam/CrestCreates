...
/// <summary>
/// Orchestration carrier for a Recall ReadCore operation. Principal,
/// InvocationContext, Origin, and Scope must agree on Tenant and caller
/// identities. <see cref="Origin"/> remains the logical security-artifact
/// origin; <see cref="Identity"/> owns only this Memory execution/fact, so
/// equality between their OperationIds is neither required nor expected.
/// </summary>
