...
internal static class AppServiceCompatibilityDiagnostics
{
    ...
    /// <summary>
    /// CEP037: Body parameter type cannot be used as a compatibility body type.
    /// The type must be a non-abstract concrete type with an accessible parameterless
    /// constructor, or an array type.
    /// </summary>
    public static readonly DiagnosticDescriptor CEP037 = new(
        id: "CEP037",
        title: "Compatibility body type must be constructible",
        messageFormat: "Method '{0}' has body parameter type '{1}' which cannot be used as a compatibility body type. The type must be a non-abstract concrete type with an accessible parameterless constructor, or an array type. Add a parameterless constructor or use [CapabilityCompatibilityIgnore] to exclude this method.",
        category: "CrestCreates.Compatibility",
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
}
