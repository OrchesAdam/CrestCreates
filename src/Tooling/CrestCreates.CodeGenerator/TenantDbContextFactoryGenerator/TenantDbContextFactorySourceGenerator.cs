...
namespace CrestCreates.CodeGenerator.TenantDbContextFactoryGenerator
{
    ...
    {
        private const string ITenantDbContextFactoryFullName = "CrestCreates.Data.EFCore.MultiTenancy.ITenantDbContextFactory";
        private const string RegistryStoreFullName = "CrestCreates.Data.EFCore.MultiTenancy.TenantDbContextFactoryRegistryStore";
