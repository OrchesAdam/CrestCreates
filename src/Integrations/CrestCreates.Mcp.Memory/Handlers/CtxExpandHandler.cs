...
/// <summary>
/// ctx_expand: resolves a source grant and expands the raw source content.
/// Zero artifact writes — no handles, no grants, no compensation token.
/// </summary>
[CapabilityName("mcp.ctx_expand")]
internal sealed class CtxExpandHandler : ICapabilityHandler<ExpandAgentMemorySourceInput, ExpandAgentMemorySourceResult>
{
