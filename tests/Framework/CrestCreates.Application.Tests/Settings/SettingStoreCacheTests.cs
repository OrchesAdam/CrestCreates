...
public class SettingStoreCacheTests
{
    ...
    {
        var definitionManager = new SettingDefinitionManager([new CoreSettingDefinitionProvider(), new TestSettingDefinitionProvider()]);
    ...
    {
        await _settingManager.SetTenantAsync(TestSettingDefinitionProvider.UserScopedDisplayName, "tenant-1", "Tenant-1");
        await _settingManager.SetTenantAsync(TestSettingDefinitionProvider.UserScopedDisplayName, "tenant-2", "Tenant-2");
        await _settingManager.SetUserAsync(TestSettingDefinitionProvider.UserScopedDisplayName, "user-1", "User-1", "tenant-1");
        await _settingManager.SetUserAsync(TestSettingDefinitionProvider.UserScopedDisplayName, "user-2", "User-2", "tenant-1");
