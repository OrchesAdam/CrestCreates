...
namespace CrestCreates.Data.EFCore.DatabaseProviders.SqlServer;
...
public class SqlServerTenantDatabaseProvisioner : ITenantDatabaseProvisioner
{
    ...
    public SqlServerTenantDatabaseProvisioner(
        ILogger<SqlServerTenantDatabaseProvisioner> logger)
    {
        _logger = logger;
    }
