...
public interface ICrestAppServiceBase<TEntity, TDto, TCreateDto, TUpdateDto, TKey>
    where TEntity : class
    where TKey : IEquatable<TKey>
{
    ...
    Task<PagedResult<TDto>> GetListAsync(PagedRequestDto request, CancellationToken cancellationToken = default);
    Task<PagedResult<TDto>> QueryAsync(QueryRequest<TEntity> request, CancellationToken cancellationToken = default);
