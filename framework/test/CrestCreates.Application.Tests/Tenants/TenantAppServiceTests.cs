...
public class TenantAppServiceTests
{
    ...
    /// <summary>
    /// Creates a TenantInitializationOrchestrator with all dependencies
    /// mocked to return success so tenant creation tests can focus on
    /// the AppService mapping logic rather than orchestrator internals.
    /// </summary>
